...
pipeline {
    ...
    environment {
	    region = "us-east-1"
        docker_repo_uri = "686603420278.dkr.ecr.us-east-1.amazonaws.com/sample-app"
	task_def_arn = "arn:aws:ecs:us-east-1:686603420278:task-definition/first-run-task-definition:2"
        cluster = "default"
        exec_role_arn = "arn:aws:iam::686603420278:role/ecsTaskExecutionRole"
    }
